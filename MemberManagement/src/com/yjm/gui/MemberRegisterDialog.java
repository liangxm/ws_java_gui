 ...
 * 
 * @author lxm
 * @version 2014-2-23 22:53:48
 */
public class MemberRegisterDialog extends AbstractDialog {

	private static final long serialVersionUID = 7535495649448718332L;
	private JPanel pane;
	...
	public MemberRegisterDialog(JFrame frame) {
		super(frame);
		initComponent();
		add(pane);
		setTitle("会员注册(办卡)");
		...
		public void actionPerformed(ActionEvent e) {
			...
			if(obj.equals(txtCardType)){
				...
				if (!StringUtil.isMobileNO(txtmphone.getText())) {
					...
					if (memberService.isPhoneExist(txtmphone.getText())) {
